    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#020817' }}>
      <div style={{ width:'100%', maxWidth:420, padding:24 }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <p style={{ color:'#64748b', fontSize:14, marginTop:6 }}>Join CampusHub today</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={handle} style={{ display:'flex', flexDirection:'column', gap:16 }}>
            ...
            <div>
              ...
              <input type="text" placeholder="Chinmayee Mahadeva" value={form.name} onChange={e=>setForm(p=>({...p,name:e.target.value}))} required />
            </div>
            <div>
            ...
            <div>
              <label style={{ display:'block', fontSize:12, color:'#94a3b8', marginBottom:6 }}>I am a</label>
